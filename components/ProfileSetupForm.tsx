  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-zinc-900 to-zinc-950">
      <form
        ...
        className="relative w-full max-w-md p-8 rounded-3xl shadow-2xl bg-gradient-to-br from-zinc-900 via-black to-zinc-950 border border-zinc-800 backdrop-blur-lg"
